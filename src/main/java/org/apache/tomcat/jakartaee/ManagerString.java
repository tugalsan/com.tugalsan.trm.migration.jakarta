...
public class ManagerString {
     ...
     */
    private ManagerString(String packageName, Locale locale) {
    ...
    private static final Map<String, Map<Locale,ManagerString>> managers =
            new Hashtable<>();
     ...
     */
    public static final ManagerString getManager(Class<?> clazz) {
     ...
     *         Locale
     */
    public static final ManagerString getManager(String packageName) {
     ...
     */
    public static final synchronized ManagerString getManager(
            String packageName, Locale locale) {

        Map<Locale,ManagerString> map = managers.get(packageName);
        if (map == null) {
            /*
             ...
             *
             */
            map = new LinkedHashMap<Locale,ManagerString>(LOCALE_CACHE_SIZE, 1, true) {
                private static final long serialVersionUID = 1L;
                @Override
                protected boolean removeEldestEntry(
                        Map.Entry<Locale,ManagerString> eldest) {
        ...
        ManagerString mgr = map.get(locale);
        if (mgr == null) {
            mgr = new ManagerString(packageName, locale);
            map.put(locale, mgr);
        }
        return mgr;
    }
